 ...
 *   PLL2M               : 2            (STM32H5_PLL2CFGR_PLLM)
 *   PLL2N               : 125          (STM32H5_PLL2CFGR_PLLN)
 *   PLL2P               : 0            (STM32H5_PLL2CFGR_PLLP)
 *   PLL2Q               : 0            (STM32H5_PLL2CFGR_PLLQ)
 *   PLL2R               : 1            (STM32H5_PLL2CFGR_PLLR)
 *   PLL3M               : 2            (STM32H5_PLL3CFGR_PLLM)
 *   PLL3N               : 125          (STM32H5_PLL3CFGR_PLLN)
 *   PLL3P               : 0            (STM32H5_PLL3CFGR_PLLP)
 *   PLL3Q               : 0            (STM32H5_PLL3CFGR_PLLQ)
 *   PLL3R               : 1            (STM32H5_PLL3CFGR_PLLR)
 *   Flash Latency(WS)   : 5
 */
...
#undef STM32H5_PLL1CFGR_PLL1R_ENABLED

#define STM32H5_PLL1FRACR_PLL1FRACN        5120ul

/* PLL2 config */

#define STM32H5_PLL2CFGR_PLL2M             RCC_PLL2CFGR_PLL2M(4)
#define STM32H5_PLL2CFGR_PLL2FRACEN        RCC_PLL2CFGR_PLL2FRACEN 
#define STM32H5_PLL2CFGR_PLL2VCOSEL        RCC_PLL2CFGR_PLL2VCOSEL
#define STM32H5_PLL2CFGR_PLL2RGE           RCC_PLL2CFGR_PLL2RGE_8_16M 

#define STM32H5_PLL2DIVR_PLL2N             RCC_PLL2DIVR_PLL2N(15)

#define STM32H5_PLL2DIVR_PLL2P             RCC_PLL2DIVR_PLL2P(1)
#define STM32H5_PLL2CFGR_PLL2P_ENABLED
#define STM32H5_PLL2DIVR_PLL2Q             0
#undef STM32H5_PLL2CFGR_PLL2Q_ENABLED
#define STM32H5_PLL2DIVR_PLL2R             0 
#undef STM32H5_PLL2CFGR_PLL2R_ENABLED

#define STM32H5_PLL2FRACR_PLL2FRACN        5120ul

/* PLL3 config */

#define STM32H5_PLL3CFGR_PLL3M             RCC_PLL3CFGR_PLL3M(4)
#define STM32H5_PLL3CFGR_PLL3FRACEN        RCC_PLL3CFGR_PLL3FRACEN 
#define STM32H5_PLL3CFGR_PLL3VCOSEL        RCC_PLL3CFGR_PLL3VCOSEL
#define STM32H5_PLL3CFGR_PLL3RGE           RCC_PLL3CFGR_PLL3RGE_8_16M 

#define STM32H5_PLL3DIVR_PLL3N             RCC_PLL3DIVR_PLL3N(15)

#define STM32H5_PLL3DIVR_PLL3P             RCC_PLL3DIVR_PLL3P(1)
#define STM32H5_PLL3CFGR_PLL3P_ENABLED
#define STM32H5_PLL3DIVR_PLL3Q             0
#undef STM32H5_PLL3CFGR_PLL3Q_ENABLED
#define STM32H5_PLL3DIVR_PLL3R             0 
#undef STM32H5_PLL3CFGR_PLL3R_ENABLED

#define STM32H5_PLL3FRACR_PLL3FRACN        5120ul
...
#define STM32H5_RCC_CFGR2_HPRE    RCC_CFGR2_HPRE_SYSCLK      /* HCLK  = SYSCLK / 1 */
#define STM32H5_HCLK_FREQUENCY    STM32H5_SYSCLK_FREQUENCY

/* Configure the APB1 prescaler */

#define STM32H5_RCC_CFGR2_PPRE1     RCC_CFGR2_PPRE1_HCLK1       /* PCLK1 = HCLK / 1 */
...
#define STM32H5_APB1_TIM12_CLKIN   (STM32H5_PCLK1_FREQUENCY)
#define STM32H5_APB1_TIM13_CLKIN   (STM32H5_PCLK1_FREQUENCY)
#define STM32H5_APB1_TIM14_CLKIN   (STM32H5_PCLK1_FREQUENCY)
#define STM32H5_APB1_LPTIM2_CLKIN  (STM32H5_PCLK1_FREQUENCY)

/* Configure the APB2 prescaler */

#define STM32H5_RCC_CFGR2_PPRE2    RCC_CFGR2_PPRE2_HCLK1       /* PCLK2 = HCLK / 1 */
#define STM32H5_PCLK2_FREQUENCY   (STM32H5_HCLK_FREQUENCY / 1)

#define STM32H5_APB2_TIM1_CLKIN   (STM32H5_PCLK2_FREQUENCY)
#define STM32H5_APB2_TIM8_CLKIN   (STM32H5_PCLK2_FREQUENCY)
#define STM32H5_APB2_TIM15_CLKIN  (STM32H5_PCLK2_FREQUENCY)
#define STM32H5_APB2_TIM16_CLKIN  (STM32H5_PCLK2_FREQUENCY)
#define STM32H5_APB2_TIM17_CLKIN  (STM32H5_PCLK2_FREQUENCY)
...
#define BOARD_TIM1_FREQUENCY    STM32H5_HCLK_FREQUENCY
#define BOARD_TIM2_FREQUENCY    STM32H5_HCLK_FREQUENCY
#define BOARD_TIM3_FREQUENCY    STM32H5_HCLK_FREQUENCY
#define BOARD_TIM4_FREQUENCY    STM32H5_HCLK_FREQUENCY
#define BOARD_TIM5_FREQUENCY    STM32H5_HCLK_FREQUENCY
#define BOARD_TIM6_FREQUENCY    STM32H5_HCLK_FREQUENCY
#define BOARD_TIM7_FREQUENCY    STM32H5_HCLK_FREQUENCY
#define BOARD_TIM8_FREQUENCY    STM32H5_HCLK_FREQUENCY
#define BOARD_TIM12_FREQUENCY   STM32H5_HCLK_FREQUENCY
#define BOARD_TIM13_FREQUENCY   STM32H5_HCLK_FREQUENCY
#define BOARD_TIM14_FREQUENCY   STM32H5_HCLK_FREQUENCY
#define BOARD_TIM15_FREQUENCY   STM32H5_HCLK_FREQUENCY
#define BOARD_TIM16_FREQUENCY   STM32H5_HCLK_FREQUENCY
#define BOARD_LPTIM1_FREQUENCY  STM32H5_HCLK_FREQUENCY
#define BOARD_LPTIM2_FREQUENCY  STM32H5_HCLK_FREQUENCY
#define BOARD_LPTIM3_FREQUENCY  STM32H5_HCLK_FREQUENCY
