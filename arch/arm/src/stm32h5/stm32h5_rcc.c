/****************************************************************************
 * arch/arm/src/stm32h5/stm32h5_rcc.c
 *
  ...
  if (!init_stat)
    {
      ...
      stm32h5_pwr_enablebkp(true);

      /* We might be changing RTCSEL - to ensure such changes work, we must
       * reset the backup domain (having backed up the RTC_MAGIC token)
       */

      modifyreg32(STM32H5_RCC_BDCR, 0, RCC_BDCR_BDRST);
      modifyreg32(STM32H5_RCC_BDCR, RCC_BDCR_BDRST, 0);
...
void stm32h5_clockconfig(void)
{
  ...
  stm32h5_stdclockconfig();

#endif

  /* Enable peripheral clocking */

  stm32h5_rcc_enableperipherals();
}
