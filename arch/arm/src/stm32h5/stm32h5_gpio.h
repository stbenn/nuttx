/****************************************************************************
 * arch/arm/src/stm32h5/stm32h5_gpio.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_STM32H5_GPIO_H
...
/* Bit-encoded input to stm32h5_configgpio() */
...
int stm32h5_gpiosetevent(uint32_t pinset, bool risingedge, bool fallingedge,
                         bool event, xcpt_t func, void *arg);

/****************************************************************************
 * Function:  stm32h5_dumpgpio
 *
 * Description:
...
int stm32h5_dumpgpio(uint32_t pinset, const char *msg);
#else
#  define stm32h5_dumpgpio(p,m)
#endif
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_ARM_SRC_STM32H5_STM32H5_GPIO_H */
