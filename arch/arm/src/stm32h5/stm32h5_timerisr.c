/****************************************************************************
 * arch/arm/src/stm32h5/stm32h5_timerisr.c
 *
...
#  define SYSTICK_RELOAD ((STM32H5_HCLK_FREQUENCY / 8 / CLK_TCK) - 1)
#else
#  define SYSTICK_RELOAD ((STM32H5_HCLK_FREQUENCY / CLK_TCK) - 1)
#endif
...
static int stm32h5_timerisr(int irq, uint32_t *regs, void *arg)
{
...
void up_timer_initialize(void)
{
  ...
  irq_attach(STM32H5_IRQ_SYSTICK, (xcpt_t)stm32h5_timerisr, NULL);
  ...
  up_enable_irq(STM32H5_IRQ_SYSTICK);
}
