...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_CRS_H
#define __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_CRS_H
...
#define STM32H5_CRS_CR_OFFSET        0x0000  /* CRS control register */
#define STM32H5_CRS_CFGR_OFFSET      0x0004  /* CRS configuration register */
#define STM32H5_CRS_ISR_OFFSET       0x0008  /* CRS interrupt and status register */
#define STM32H5_CRS_ICR_OFFSET       0x000c  /* CRS interrupt flag clear register */

/* Register Addresses *******************************************************/

#define STM32H5_CRS_CR               (STM32H5_CRS_BASE + STM32H5_CRS_CR_OFFSET)
#define STM32H5_CRS_CFGR             (STM32H5_CRS_BASE + STM32H5_CRS_CFGR_OFFSET)
#define STM32H5_CRS_ISR              (STM32H5_CRS_BASE + STM32H5_CRS_ISR_OFFSET)
#define STM32H5_CRS_ICR              (STM32H5_CRS_BASE + STM32H5_CRS_ICR_OFFSET)
...
#endif /* __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_CRS_H */
