/****************************************************************************
 * arch/arm/src/stm32h5/hardware/stm32h562xx_rcc.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H562XX_RCC_H
...
#define STM32H5_RCC_APB1LENR_OFFSET     0x009c  /* RCC APB1 peripheral clock enable register 1 */
#define STM32H5_RCC_APB1HENR_OFFSET     0x00a0  /* RCC APB1 peripheral clock enable register 2 */
...
#define STM32H5_RCC_CRRCR        (STM32H5_RCC_BASE + STM32H5_RCC_CRRCR_OFFSET)
#define STM32H5_RCC_CFGR1        (STM32H5_RCC_BASE + STM32H5_RCC_CFGR1_OFFSET)
#define STM32H5_RCC_CFGR2        (STM32H5_RCC_BASE + STM32H5_RCC_CFGR2_OFFSET)
#define STM32H5_RCC_PLL1CFGR     (STM32H5_RCC_BASE + STM32H5_RCC_PLL1CFGR_OFFSET)
#define STM32H5_RCC_PLL2CFGR     (STM32H5_RCC_BASE + STM32H5_RCC_PLL2CFGR_OFFSET)
#define STM32H5_RCC_PLL3CFGR     (STM32H5_RCC_BASE + STM32H5_RCC_PLL3CFGR_OFFSET)
#define STM32H5_RCC_PLL1DIVR     (STM32H5_RCC_BASE + STM32H5_RCC_PLL1DIVR_OFFSET)
#define STM32H5_RCC_PLL1FRACR    (STM32H5_RCC_BASE + STM32H5_RCC_PLL1FRACR_OFFSET)
#define STM32H5_RCC_PLL2DIVR     (STM32H5_RCC_BASE + STM32H5_RCC_PLL2DIVR_OFFSET)
#define STM32H5_RCC_PLL2FRACR    (STM32H5_RCC_BASE + STM32H5_RCC_PLL2FRACR_OFFSET)
#define STM32H5_RCC_PLL3DIVR     (STM32H5_RCC_BASE + STM32H5_RCC_PLL3DIVR_OFFSET)
#define STM32H5_RCC_PLL3FRACR    (STM32H5_RCC_BASE + STM32H5_RCC_PLL3FRACR_OFFSET)
#define STM32H5_RCC_CIER         (STM32H5_RCC_BASE + STM32H5_RCC_CIER_OFFSET)
#define STM32H5_RCC_CIFR         (STM32H5_RCC_BASE + STM32H5_RCC_CIFR_OFFSET)
#define STM32H5_RCC_CICR         (STM32H5_RCC_BASE + STM32H5_RCC_CICR_OFFSET)
#define STM32H5_RCC_AHB1RSTR     (STM32H5_RCC_BASE + STM32H5_RCC_AHB1RSTR_OFFSET)
#define STM32H5_RCC_AHB2RSTR     (STM32H5_RCC_BASE + STM32H5_RCC_AHB2RSTR_OFFSET)
#define STM32H5_RCC_AHB4RSTR     (STM32H5_RCC_BASE + STM32H5_RCC_AHB4RSTR_OFFSET)
#define STM32H5_RCC_APB1LRSTR    (STM32H5_RCC_BASE + STM32H5_RCC_APB1LRSTR_OFFSET)
#define STM32H5_RCC_APB1HRSTR    (STM32H5_RCC_BASE + STM32H5_RCC_APB1HRSTR_OFFSET)
#define STM32H5_RCC_APB2RSTR     (STM32H5_RCC_BASE + STM32H5_RCC_APB2RSTR_OFFSET)
#define STM32H5_RCC_APB3RSTR     (STM32H5_RCC_BASE + STM32H5_RCC_APB3RSTR_OFFSET)
#define STM32H5_RCC_AHB1ENR      (STM32H5_RCC_BASE + STM32H5_RCC_AHB1ENR_OFFSET)
#define STM32H5_RCC_AHB2ENR      (STM32H5_RCC_BASE + STM32H5_RCC_AHB2ENR_OFFSET)
#define STM32H5_RCC_AHB4ENR      (STM32H5_RCC_BASE + STM32H5_RCC_AHB4ENR_OFFSET)
#define STM32H5_RCC_APB1LENR     (STM32H5_RCC_BASE + STM32H5_RCC_APB1LENR_OFFSET)
#define STM32H5_RCC_APB1HENR     (STM32H5_RCC_BASE + STM32H5_RCC_APB1HENR_OFFSET)
#define STM32H5_RCC_APB2ENR      (STM32H5_RCC_BASE + STM32H5_RCC_APB2ENR_OFFSET)
#define STM32H5_RCC_APB3ENR      (STM32H5_RCC_BASE + STM32H5_RCC_APB3ENR_OFFSET)
#define STM32H5_RCC_AHB1LPENR    (STM32H5_RCC_BASE + STM32H5_RCC_AHB1LPENR_OFFSET)
#define STM32H5_RCC_AHB2LPENR    (STM32H5_RCC_BASE + STM32H5_RCC_AHB2LPENR_OFFSET)
#define STM32H5_RCC_AHB4LPENR    (STM32H5_RCC_BASE + STM32H5_RCC_AHB4LPENR_OFFSET)
#define STM32H5_RCC_APB1LPENR    (STM32H5_RCC_BASE + STM32H5_RCC_APB1LPENR1_OFFSET)
#define STM32H5_RCC_APB1HPENR    (STM32H5_RCC_BASE + STM32H5_RCC_APB1LPENR2_OFFSET)
#define STM32H5_RCC_APB2LPENR    (STM32H5_RCC_BASE + STM32H5_RCC_APB2LPENR_OFFSET)
#define STM32H5_RCC_APB3LPENR    (STM32H5_RCC_BASE + STM32H5_RCC_APB3LPENR_OFFSET)
#define STM32H5_RCC_CCIPR1       (STM32H5_RCC_BASE + STM32H5_RCC_CCIPR1_OFFSET)
#define STM32H5_RCC_CCIPR2       (STM32H5_RCC_BASE + STM32H5_RCC_CCIPR2_OFFSET)
#define STM32H5_RCC_CCIPR3       (STM32H5_RCC_BASE + STM32H5_RCC_CCIPR3_OFFSET)
#define STM32H5_RCC_CCIPR4       (STM32H5_RCC_BASE + STM32H5_RCC_CCIPR4_OFFSET)
#define STM32H5_RCC_CCIPR5       (STM32H5_RCC_BASE + STM32H5_RCC_CCIPR5_OFFSET)
#define STM32H5_RCC_BDCR         (STM32H5_RCC_BASE + STM32H5_RCC_BDCR_OFFSET)
#define STM32H5_RCC_RSR          (STM32H5_RCC_BASE + STM32H5_RCC_RSR_OFFSET)
#define STM32H5_RCC_SECCFGR      (STM32H5_RCC_BASE + STM32H5_RCC_SECCFGR_OFFSET)
#define STM32H5_RCC_PRIVCFGR     (STM32H5_RCC_BASE + STM32H5_RCC_PRIVCFGR_OFFSET)
