/****************************************************************************
 * arch/arm/src/stm32h5/hardware/stm32h5_pwr.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_PWR_H
#define __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_PWR_H
...
#define STM32H5_PWR_PMCR_OFFSET     0x0000  /* Power Mode Control */
#define STM32H5_PWR_PMSR_OFFSET     0x0004  /* Power Mode Status */
#define STM32H5_PWR_VOSCR_OFFSET    0x0010  /* Voltage Scaling Control */
#define STM32H5_PWR_VOSSR_OFFSET    0x0014  /* Voltage Scaling Status */
#define STM32H5_PWR_BDCR_OFFSET     0x0020  /* Backup Domain Control */
#define STM32H5_PWR_DBPCR_OFFSET    0x0024  /* Backup Domain Protection Control */
#define STM32H5_PWR_BDSR_OFFSET     0x0028  /* Backup Domain Status */
#define STM32H5_PWR_UCPDR_OFFSET    0x002c  /* USB-C Power Delivery */
#define STM32H5_PWR_SCCR_OFFSET     0x0030  /* Supply Configuration Control */
#define STM32H5_PWR_VMCR_OFFSET     0x0034  /* Voltage Monitor Control */
#define STM32H5_PWR_USBSCR_OFFSET   0x0038  /* USB Supply Control */
#define STM32H5_PWR_VMSR_OFFSET     0x003c  /* Voltage Monitor Status */
#define STM32H5_PWR_WUSCR_OFFSET    0x0040  /* Wake-Up Status Clear */
#define STM32H5_PWR_WUSR_OFFSET     0x0044  /* Wake-Up Status */
#define STM32H5_PWR_WUCR_OFFSET     0x0048  /* Wake-Up Configuration */
#define STM32H5_PWR_IORETR_OFFSET   0x0050  /* I/O Retention */
#define STM32H5_PWR_SECCFGR_OFFSET  0x0100  /* Power secure configuration register */
#define STM32H5_PWR_PRIVCFGR_OFFSET 0x0104  /* Power privilege configuration register */

/* Register Addresses *******************************************************/

#define STM32H5_PWR_PMCR         (STM32H5_PWR_BASE + STM32H5_PWR_PMCR_OFFSET)
#define STM32H5_PWR_PMSR         (STM32H5_PWR_BASE + STM32H5_PWR_PMSR_OFFSET)
#define STM32H5_PWR_VOSCR        (STM32H5_PWR_BASE + STM32H5_PWR_VOSCR_OFFSET)
#define STM32H5_PWR_VOSSR        (STM32H5_PWR_BASE + STM32H5_PWR_VOSSR_OFFSET)
#define STM32H5_PWR_BDCR         (STM32H5_PWR_BASE + STM32H5_PWR_BDCR_OFFSET)
#define STM32H5_PWR_DBPCR        (STM32H5_PWR_BASE + STM32H5_PWR_DBPCR_OFFSET)
#define STM32H5_PWR_BDSR         (STM32H5_PWR_BASE + STM32H5_PWR_BDSR_OFFSET)
#define STM32H5_PWR_UCPDR        (STM32H5_PWR_BASE + STM32H5_PWR_UCPDR_OFFSET)
#define STM32H5_PWR_SCCR         (STM32H5_PWR_BASE + STM32H5_PWR_SCCR_OFFSET)
#define STM32H5_PWR_VMCR         (STM32H5_PWR_BASE + STM32H5_PWR_VMCR_OFFSET)
#define STM32H5_PWR_USBSCR       (STM32H5_PWR_BASE + STM32H5_PWR_USBSCR_OFFSET)
#define STM32H5_PWR_VMSR         (STM32H5_PWR_BASE + STM32H5_PWR_VMSR_OFFSET)
#define STM32H5_PWR_WUSCR        (STM32H5_PWR_BASE + STM32H5_PWR_WUSCR_OFFSET)
#define STM32H5_PWR_WUSR         (STM32H5_PWR_BASE + STM32H5_PWR_WUSR_OFFSET)
#define STM32H5_PWR_WUCR         (STM32H5_PWR_BASE + STM32H5_PWR_WUCR_OFFSET)
#define STM32H5_PWR_IORETR       (STM32H5_PWR_BASE + STM32H5_PWR_IORETR_OFFSET)
#define STM32H5_PWR_SECCFGR      (STM32H5_PWR_BASE + STM32H5_PWR_SECCFGR_OFFSET)
#define STM32H5_PWR_PRIVCFGR     (STM32H5_PWR_BASE + STM32H5_PWR_PRIVCFGR_OFFSET)
...
#endif /* __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_PWR_H */
