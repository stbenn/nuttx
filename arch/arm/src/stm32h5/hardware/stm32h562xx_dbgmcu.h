/****************************************************************************
 * arch/arm/src/stm32h5/hardware/stm32h562xx_dbgmcu.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H562XX_DBGMCU_H
...
#define DBGMCU_APB1L_TIM2STOP      (1 << 0)   /* Bit 0: TIM2 stopped when core is halted */
#define DBGMCU_APB1L_TIM3STOP      (1 << 1)   /* Bit 1: TIM3 stopped when core is halted */
#define DBGMCU_APB1L_TIM4STOP      (1 << 2)   /* Bit 2: TIM4 stopped when core is halted */
#define DBGMCU_APB1L_TIM5STOP      (1 << 3)   /* Bit 3: TIM5 stopped when core is halted */
#define DBGMCU_APB1L_TIM6STOP      (1 << 4)   /* Bit 4: TIM6 stopped when core is halted */
#define DBGMCU_APB1L_TIM7STOP      (1 << 5)   /* Bit 5: TIM7 stopped when core is halted */
#define DBGMCU_APB1L_TIM12STOP     (1 << 6)   /* Bit 6: TIM12 stopped when core is halted */
#define DBGMCU_APB1L_TIM13STOP     (1 << 7)   /* Bit 6: TIM12 stopped when core is halted */
#define DBGMCU_APB1L_TIM14STOP     (1 << 8)   /* Bit 6: TIM12 stopped when core is halted */
#define DBGMCU_APB1L_WWDGSTOP      (1 << 11)  /* Bit 11: Window Watchdog stopped when core is halted */
#define DBGMCU_APB1L_IWDGSTOP      (1 << 12)  /* Bit 12: Independent Watchdog stopped when core is halted */
#define DBGMCU_APB1L_I2C1STOP      (1 << 21)  /* Bit 21: I2C1 SMBUS timeout mode stopped when Core is halted */
#define DBGMCU_APB1L_I2C2STOP      (1 << 22)  /* Bit 22: I2C2 SMBUS timeout mode stopped when Core is halted */
#define DBGMCU_APB1L_I3C1STOP      (1 << 23)  /* Bit 23: I2C3 SMBUS timeout mode stopped when Core is halted */

/* Debug MCU APB1H freeze register */

#define DBGMCU_APB1H_LPTIM2STOP    (1 << 5)   /* Bit 5: LPTIM2 stopped when core is halted */
...
#define DBGMCU_APB3_I2C3STOP     (1 << 10)    /* Bit 10: I2C3 SMBUS stop in debug */
#define DBGMCU_APB3_I2C4STOP     (1 << 11)    /* Bit 11: I2C4 SMBUS stop in debug */
#define DBGMCU_APB3_LPTIM1STOP   (1 << 17)    /* Bit 17: LPTIM1 stopped in debug */
#define DBGMCU_APB3_LPTIM3STOP   (1 << 18)    /* Bit 18: LPTIM3 stopped in debug */
#define DBGMCU_APB3_LPTIM4STOP   (1 << 19)    /* Bit 19: LPTIM4 stopped in debug */
...
#endif /* __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H562XXDBGMCU_H */
