...
#  define BOARD_QSPI_CLK        RCC_CCIPR4_OCTOSPI1SEL_RCCHCLK4
#  define QSPI_CLK_FREQUENCY    STM32_HCLK_FREQUENCY / 4
#endif
...
static int qspi_hw_initialize(struct stm32_qspidev_s *priv)
{
  ...
  regval  = qspi_getreg(priv, STM32_QUADSPI_DCR1_OFFSET);
  regval &= ~(QSPI_DCR1_CKMODE | QSPI_DCR1_CSHT_MASK | QSPI_DCR1_DEVSIZE_MASK);
  regval |= (0x00);
  ...
  if (intf == 0)
    {
      ...
      modreg32 (BOARD_QSPI_CLK, RCC_CCIPR4_OCTOSPI1SEL_MASK, STM32_RCC_CCIPR4);
