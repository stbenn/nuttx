...
#  define BOARD_QSPI_CLK        RCC_CCIPR4_OCTOSPI1SEL_PLL1QCK
                                 ...
                                 const struct qspi_meminfo_s *meminfo)
{
  ...
  if (meminfo->altmode != CCR_ABMODE_NONE)
    {
      xctn->altbytesmode = CCR_ABMODE_SINGLE;
      xctn->altbytessize = meminfo->altsize;
      xctn->altbytes = meminfo->altbytes;
    }
  else
    {
      xctn->altbytesmode = CCR_ABMODE_NONE;
  ...
  if (intf == 0)
    {
      ...
      modreg32 (BOARD_QSPI_CLK,
                RCC_CCIPR4_OCTOSPI1SEL_MASK,
                STM32_RCC_CCIPR4);
