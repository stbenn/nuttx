/****************************************************************************
 * arch/arm/src/stm32h5/stm32h5_rcc.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_STM32H5_RCC_H
#define __ARCH_ARM_SRC_STM32H5_STM32H5_RCC_H
 ...
 *   function called stm32h5_board_clockconfig().
 *
 * Input Parameters:
 *   None
 *
...
void stm32h5_clockconfig(void);

/****************************************************************************
 * Name: stm32h5_board_clockconfig
 *
 * Description:
...
void stm32h5_board_clockconfig(void);
#endif
 ...
 *   stm32h5_clockconfig():  It does not reset any devices, and it does not
...
#ifdef CONFIG_PM
void stm32h5_clockenable(void);
#endif

/****************************************************************************
 * Name: stm32h5_rcc_enablelse
 *
 * Description:
...
void stm32h5_rcc_enablelse(void);

/****************************************************************************
 * Name: stm32h5_rcc_enablelsi
 *
 * Description:
...
void stm32h5_rcc_enablelsi(void);

/****************************************************************************
 * Name: stm32h5_rcc_disablelsi
 *
 * Description:
...
void stm32h5_rcc_disablelsi(void);
...
#endif
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_ARM_SRC_STM32H5_STM32H5_RCC_H */
