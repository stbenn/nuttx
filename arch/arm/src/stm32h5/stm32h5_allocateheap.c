...
#define SRAM1_START  STM32H5_SRAM_BASE
...
void up_allocate_heap(void **heap_start, size_t *heap_size)
{
  ...
  *heap_size  = usize;
  ...
  stm32h5_mpu_uheap((uintptr_t)ubase, usize);
#else
...
void arm_addregion(void)
{
  ...
  stm32h5_mpu_uheap((uintptr_t)SRAM2_START, SRAM2_END - SRAM2_START);
  ...
  stm32h5_mpu_uheap((uintptr_t)SRAM3_START, SRAM3_END - SRAM3_START);
  ...
  stm32h5_mpu_uheap((uintptr_t)CONFIG_HEAP2_BASE, CONFIG_HEAP2_SIZE);
