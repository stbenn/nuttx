/****************************************************************************
 * arch/arm/src/stm32h5/stm32_usbdev.c
 *
...
#include "hardware/stm32_usb.h"
#include "stm32_gpio.h"
#include "stm32_usbdev.h"

#if defined(CONFIG_USBDEV) && defined(CONFIG_STM32H5_USB)
...
#  undef CONFIG_STM32H5USBDEV_REGDEBUG
#endif
...
#ifdef CONFIG_STM32H5USBDEV_REGDEBUG
...
#endif /* CONFIG_USBDEV && CONFIG_STM32H5_USB */
