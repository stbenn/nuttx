/****************************************************************************
 * arch/arm/src/stm32h5/stm32h5_lowputc.c
 *
...
#    define STM32H5_CONSOLE_BASE     STM32H5_LPUART1_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB3ENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_USART1_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK2_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB2ENR 
...
#    define STM32H5_CONSOLE_BASE     STM32H5_USART2_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_USART3_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_UART4_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_UART5_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_USART6_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_UART7_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_UART8_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_UART9_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_USART10_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_USART11_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#    define STM32H5_CONSOLE_BASE     STM32H5_UART12_BASE
#    define STM32H5_APBCLOCK         STM32H5_PCLK1_FREQUENCY
#    define STM32H5_CONSOLE_APBREG   STM32H5_RCC_APB1LENR
...
#  if STM32H5_CONSOLE_BASE == STM32H5_LPUART1_BASE
...
void arm_lowputc(char ch)
{
  ...
  while ((getreg32(STM32H5_CONSOLE_BASE + STM32H5_USART_ISR_OFFSET) &
         USART_ISR_TXE) == 0);
#ifdef STM32H5_CONSOLE_RS485_DIR
  stm32h5_gpiowrite(STM32H5_CONSOLE_RS485_DIR,
                    STM32H5_CONSOLE_RS485_DIR_POLARITY);
#endif

  /* Then send the character */

  putreg32((uint32_t)ch, STM32H5_CONSOLE_BASE + STM32H5_USART_TDR_OFFSET);
...
void stm32h5_lowsetup(void)
{
  ...
  stm32h5_configgpio(STM32H5_CONSOLE_TX);
#endif
#ifdef STM32H5_CONSOLE_RX
  stm32h5_configgpio(STM32H5_CONSOLE_RX);
#endif

#ifdef STM32H5_CONSOLE_RS485_DIR
  stm32h5_configgpio(STM32H5_CONSOLE_RS485_DIR);
  stm32h5_gpiowrite(STM32H5_CONSOLE_RS485_DIR,
                    !STM32H5_CONSOLE_RS485_DIR_POLARITY);
#endif
  ...
  cr  = getreg32(STM32H5_CONSOLE_BASE + STM32H5_USART_CR2_OFFSET);
  cr &= ~USART_CR2_CLRBITS;
  cr |= USART_CR2_SETBITS;
  putreg32(cr, STM32H5_CONSOLE_BASE + STM32H5_USART_CR2_OFFSET);

  /* Configure CR1 */

  cr  = getreg32(STM32H5_CONSOLE_BASE + STM32H5_USART_CR1_OFFSET);
  cr &= ~USART_CR1_CLRBITS;
  cr |= USART_CR1_SETBITS;
  putreg32(cr, STM32H5_CONSOLE_BASE + STM32H5_USART_CR1_OFFSET);

  /* Configure CR3 */

  cr  = getreg32(STM32H5_CONSOLE_BASE + STM32H5_USART_CR3_OFFSET);
  cr &= ~USART_CR3_CLRBITS;
  cr |= USART_CR3_SETBITS;
  putreg32(cr, STM32H5_CONSOLE_BASE + STM32H5_USART_CR3_OFFSET);

  /* Configure the USART Baud Rate */

  putreg32(STM32H5_BRR_VALUE,
           STM32H5_CONSOLE_BASE + STM32H5_USART_BRR_OFFSET);
