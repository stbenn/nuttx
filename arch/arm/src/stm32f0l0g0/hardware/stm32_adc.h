...
#  define STM32_ADC_CCR_OFFSET      0x0308  /* Common control register */
#else
...
/* ADC channel selection alternate register - Enabled when CHSELRMOD = 1 in ADC_CFGR1 */
...
#  define ADC_CCR_PRESC_4           (2 << ADC_CCR_PRESC_SHIFT)
#  define ADC_CCR_PRESC_6           (3 << ADC_CCR_PRESC_SHIFT)
#  define ADC_CCR_PRESC_8           (4 << ADC_CCR_PRESC_SHIFT)
#  define ADC_CCR_PRESC_10          (5 << ADC_CCR_PRESC_SHIFT)
#  define ADC_CCR_PRESC_12          (6 << ADC_CCR_PRESC_SHIFT)
#  define ADC_CCR_PRESC_16          (7 << ADC_CCR_PRESC_SHIFT)
#  define ADC_CCR_PRESC_32          (8 << ADC_CCR_PRESC_SHIFT)
#  define ADC_CCR_PRESC_64          (9 << ADC_CCR_PRESC_SHIFT)
#  define ADC_CCR_PRESC_128         (10 << ADC_CCR_PRESC_SHIFT)
#  define ADC_CCR_PRESC_256         (11 << ADC_CCR_PRESC_SHIFT)
