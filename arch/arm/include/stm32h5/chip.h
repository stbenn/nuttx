...
#  define STM32H5_SRAM2_SIZE       (80*1024)   /* 64Kb  SRAM2 on AHB bus Matrix */
#  define STM32H5_SRAM3_SIZE       (64*1024)   /* 64Kb  SRAM2 on AHB bus Matrix */
...
/* TODO - Add new features for H5 later */
